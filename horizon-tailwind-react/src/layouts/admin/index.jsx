      ...
      <div className="h-full w-full bg-lightPrimary dark:!bg-navy-900">
        ...
        >
          ...
          <div className="h-full">
            ...
            <div className="font-bold text-xl "> This is The Admin DashBoard</div>
            <div className="font-bold text-xl bg-blueSecondary  rounded-xl p-1" >
              <div className="flex items-center justify-center">
              <IoMdAdd className="text-white" />
           
              <button className="bg-blueSecondary text-white" onClick={()=>{
                setPop(true);
              }}  >    Organization</button>
